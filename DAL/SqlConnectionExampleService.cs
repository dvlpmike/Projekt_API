...
namespace Projekt_API.DAL
{
    public class SqlConnectionExampleService : IExampleService
    {
        //Proszę tutaj wpisać swój connection string
        private readonly string ConnStr = @"Data Source=srv-test-db-1\test1;Initial Catalog=Projekt_API;Integrated Security=True;";
